...
function ManualOverrideModal({ block, taskById, onClose, decideBlock, t }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between bg-gradient-to-r from-[#1e3a8a] to-[#1e40af] px-6 py-4 sticky top-0 z-10">
          <div>
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="mt-2">
            ...
            <textarea
              ...
              rows={2}
              className="w-full border border-slate-200 rounded-xl px-4 py-3 text-xs text-slate-700 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/30 focus:border-[#1e3a8a] resize-none placeholder-slate-400 transition-all"
            />
          </div>
        </div>
        ...
        <div className="px-5 pb-5 flex gap-3 sticky bottom-0 bg-white/90 backdrop-blur-sm pt-2">
          ...
          <button
            ...
            disabled={!canApply}
            className="flex-1 py-2.5 rounded-xl bg-[#1e3a8a] text-xs font-bold text-white hover:bg-[#1e40af] transition-colors shadow-sm disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Apply Override
          </button>
        </div>
...
export default function ConflictResolution({ setPage }) {
  ...
  return (
    <div className="bg-[#FDF9F1] rounded-3xl min-h-full overflow-hidden pb-6">
      ...
      <div className="p-6">
        <h2 className="text-3xl font-serif font-black text-[#1e3a8a] tracking-tight">{t('cr.title')}</h2>
      ...
      <div className="px-6">
        <section className="mb-10">
          <h3 className="mb-4 flex items-center gap-2 text-lg font-bold text-slate-900 tracking-tight pb-3">
            <GitMerge size={18} className="text-[#1e3a8a]" /> {t('cr.merged_blocks')}
          </h3>
              ...
              {mergedBlocks.map((b) => (
                <div key={b.block_id} className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm transition-transform hover:-translate-y-1 flex flex-col">
                  <div className="flex items-center justify-between bg-slate-50 px-5 py-3 border-b border-slate-200">
                    ...
                    <span className="bg-[#FDF9F1] border border-slate-200 px-2 py-0.5 rounded text-xs font-bold text-[#1e3a8a]">
                  ...
                  <div className="bg-slate-50 px-5 py-4 border-t border-slate-200 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="focus-ring flex items-center gap-1.5 bg-[#1e3a8a] rounded-lg px-4 py-2 text-xs font-bold text-white transition hover:bg-[#1e40af] disabled:opacity-40 shadow-sm"
                    >
        ...
        <section>
          <h3 className="mb-4 flex items-center gap-2 text-lg font-bold text-slate-900 tracking-tight pb-3">
            <Users size={18} className="text-[#1e3a8a]" /> {t('cr.capacity_conflicts')}
          </h3>
              ...
              {capacityConflicts.map((group) => (
                <div key={group.section} className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                  <div className="bg-slate-50 px-5 py-3 border-b border-slate-200 flex items-center gap-2 text-sm font-bold text-slate-900">
                    <AlertOctagon size={16} className="text-[#1e3a8a]" /> {group.section}
                  ...
                  <div className="bg-slate-50 px-5 py-4 border-t border-slate-200 flex flex-wrap items-center gap-3">
                    ...
                    <button
                      ...
                      className="focus-ring ml-auto text-[11px] font-bold text-[#1e3a8a] uppercase tracking-wider hover:underline"
                    >
